...
public class Main {
    ...
    // Method for converting unsigned numbers to decimal
    ...
    // Method to check is given string contains just zeros
    ...
    // Method  for adding 1 to the binary number for rounding it up
